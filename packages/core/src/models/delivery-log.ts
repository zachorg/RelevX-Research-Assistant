...
export interface DeliveryLog {
  ...
  // Status
  status: "success" | "failed" | "partial"; // Delivery status
  ...
  // Timestamps
  deliveredAt: number; // When delivery was attempted/completed
 ...
 */
export interface NewDeliveryLog
  extends Omit<DeliveryLog, "id"> {}
